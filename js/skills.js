...
(function () {
  ...
  var skills = [
    ...
    { name: 'pgx', group: 'backend' },
    { name: 'Celery', group: 'backend' },
    { name: 'Echo', group: 'backend' },
    { name: 'Chi', group: 'backend' },
    { name: 'goroutines', group: 'backend' },
    { name: 'Protocol Buffers', group: 'backend' },
    { name: 'pandas', group: 'data' },
    { name: 'sqlc', group: 'backend' },
    { name: 'ClickHouse', group: 'data' },
    { name: 'Claude API', group: 'data' },
    { name: 'LangChain', group: 'data' },
    { name: 'RAG', group: 'data' },
    { name: 'MCP', group: 'data' },
    { name: 'AI Agents', group: 'data' },
    { name: 'OpenAI API', group: 'data' },
    { name: 'Embeddings', group: 'data' },
    { name: 'PostgreSQL', group: 'infra' },
    { name: 'kafka-go', group: 'backend' },
    { name: 'MongoDB', group: 'infra' },
    { name: 'Redis', group: 'infra' },
    { name: 'Kafka', group: 'infra' },
    { name: 'RabbitMQ', group: 'infra' },
    ...
    { name: 'System Design', group: 'infra' },
    { name: 'DDD', group: 'infra' },
    { name: 'Clean Architecture', group: 'infra' }
  ];
